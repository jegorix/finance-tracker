...
Сценарий ориентирован на текущее состояние вашей БД, где уже существуют пользователи `Egor Nowicki`, `Andrey Kotov` и другие записи с `id` до `17` в `transactions`.
